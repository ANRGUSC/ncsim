...
Interactive web visualization for [ncsim](../ncsim/) trace playback. Configure experiments, run simulations, and explore network topology, DAG structure, scheduling decisions, and animated execution replay.
...
- **Node.js** 18+ (frontend)
- **Python** 3.12+ (backend)
- **ncsim** installed (`pip install -e ../ncsim/`)
