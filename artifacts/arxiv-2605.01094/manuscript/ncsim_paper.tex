...
\path{artifacts/arxiv-2605.01094/} for the repository's \texttt{paper} branch
(\Cref{tab:artifact}). The folder is prepared locally; public release is
pending. It contains the inputs, saved observations, analysis scripts, and
...
\midrule
\input{generated/routing_rows.tex}
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Net.} & \textbf{DAG} &
  ...
  \textbf{Solo} & \textbf{Full} & \textbf{Slow.} \\
\midrule
\input{generated/interference_rows.tex}
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Net.} & \textbf{DAG} &
  ...
  \textbf{H} & \textbf{C} & \textbf{RR} & \textbf{Solo$\downarrow$} \\
\midrule
\input{generated/winner_rows.tex}
\bottomrule
\end{tabular}
\end{table*}
