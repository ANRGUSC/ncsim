/*
 * ns-3 Experiment 1: N-Way CSMA Contention Scaling
 *
...
main(int argc, char* argv[])
{
    ...
    double warmup = 2.0;       // discard first 2s
    ...
    // --- Mobility: STAs at (0, i*5), APs at (30, i*5) ---
    ...
    for (uint32_t i = 0; i < nLinks; ++i)
    {
        ...
        apPos->Add(Vector(30.0, i * 5.0, 0.0));
    }
    ...
    std::string fname = outDir + "/contention_n" + std::to_string(nLinks)
