...
Error bars are 95\% CIs over 30 seeds. The \heftone{}/\hefttwo{} gap
collapses from $\sim 100\times$ to roughly $2\times$, confirming that
CSMA/CA contention is the mechanism behind the headline effects.}
\label{fig:noint}
\end{figure}
