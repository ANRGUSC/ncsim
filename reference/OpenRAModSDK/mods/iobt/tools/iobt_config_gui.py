...
class IoBTConfigGUI:
    ...
    def _create_widgets(self):
        ...
        ttk.Label(dag_frame, text="ticks").grid(row=2, column=2, sticky="w")

        # DAG Preview
        ttk.Label(dag_frame, text="Preview:").grid(row=3, column=0, sticky="nw", pady=5)
        self.dag_preview_text = tk.Text(dag_frame, height=6, width=35, font=("Courier", 9))
        self.dag_preview_text.grid(row=3, column=1, columnspan=2, sticky="w", pady=5)
